...
<html>
  ...
  <body>
          ...
          <nav class="uk-navbar" uk-navbar>
            ...
            <div class="uk-navbar-right">
              <div class="uk-navbar-item">
                <a target="_blank" href="https://github.com/open-games-community" class="uk-icon-button gitlab uk-margin-small-right"><i class="fab fa-gitlab"></i></a>
    ...
    <section class="uk-section uk-section-xsmall">
      <div class="uk-container">
        <h5 class="uk-h5 uk-text-center uk-margin-remove">Copyright <i class="far fa-copyright"></i> <?= date('Y'); ?> <span class="uk-text-bold">BlizzCMS by <a href="https://opengamescommunity.com">Alex</a></span>. All rights reserved</h5>
      </div>
    </section>
  </body>
</html>
